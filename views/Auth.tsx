  ...
  return (
    <div className="min-h-screen bg-[#FAF9F7] flex flex-col lg:flex-row">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-blue-600 p-20 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-6 text-blue-100/60 font-bold text-xs uppercase tracking-widest">
          ...
          <div className="bg-white rounded-[40px] border border-slate-200 shadow-2xl shadow-slate-200/50 overflow-hidden">
            <div className="p-10">
              ...
              <form onSubmit={handleAuth} className="space-y-6">
                ...
                <button
                  disabled={loading}
                  className="w-full py-5 bg-slate-900 text-white rounded-[24px] font-black text-xs uppercase tracking-widest shadow-xl shadow-slate-200 hover:bg-slate-800 transition-all flex items-center justify-center gap-3 active:scale-[0.98]"
                >
            ...
            <div className="bg-slate-50/80 p-8 border-t border-slate-100 text-center">
              <button
                ...
                className="group inline-flex items-center gap-2 text-[10px] font-black text-slate-400 hover:text-blue-600 uppercase tracking-widest transition-all"
              >
                {isSignUp ? (
