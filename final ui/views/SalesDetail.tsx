            ...
            <div className="relative z-10">
              <div className="flex justify-between mb-16">
                ...
                <div className="text-right">
                  ...
                  <div className="text-base space-y-3">
                    ...
                    <div>
                      <p className="text-slate-400 font-black uppercase tracking-widest text-xs mt-4">Issue Date</p>
                      <p className="font-black text-slate-900 text-lg">{formatDate(doc.createdAt)}</p>
                    </div>
                    {doc.paymentTerms && (
                      <div>
                        <p className="text-slate-400 font-black uppercase tracking-widest text-xs mt-4">Payment Terms</p>
                        <p className="font-black text-slate-900 text-lg">{doc.paymentTerms}</p>
                      </div>
                    )}
                    {doc.poNumber && (
                      <div>
                        <p className="text-slate-400 font-black uppercase tracking-widest text-xs mt-4">PO Number</p>
              ...
              <div className="grid grid-cols-2 gap-12 mb-5 py-0 border-y border-slate-100">
                <div>
                  ...
                  {doc.shipTo && (
                    <>
                      <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-6 mb-4">Ship To</h4>
                      <div className="text-base space-y-1 whitespace-pre-line">
                        {doc.shipTo}
                      </div>
                    </>
                ...
                <div className="text-right">
                  <h4 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-4">Project</h4>
              ...
              <table className="w-full mb-6">
                <thead>
                  <tr className="border-b-2 border-slate-900 text-[15px] font-black uppercase tracking-widest text-slate-900">
              ...
              <div className="flex justify-end">
                <div className="w-96 space-y-2">
                  <div className="flex justify-between text-slate-400 font-black uppercase text-sm tracking-widest">
                    <span>Subtotal</span>
                  ...
                  {doc.discount > 0 && (
                    <div className="flex justify-between text-rose-500 font-black uppercase text-sm tracking-widest">
                      <span>Discount</span>
                  ...
                  <div className="flex justify-between items-center pt-3 border-t-4 border-slate-900">
                    <span className="text-[18px] font-black text-slate-900 uppercase tracking-widest">Total Amount</span>
                    <span className="text-[20px] font-black text-blue-600">{formatCurrency(doc.total, currencyCode)}</span>
                  </div>
                  {doc.amountPaid > 0 && (
                    <div className="flex justify-between text-emerald-600 font-black uppercase text-sm tracking-widest">
                  ...
                  <div className="flex justify-between items-center pt-2 border-t-2 border-slate-900">
                    <span className="text-[16px] font-black text-slate-900 uppercase tracking-widest">Balance Due</span>
              ...
              <div className="mt-12 border-t border-slate-100 space-y-6">
                {doc.notes && (
                  <div>
                    <h4 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-4">Notes</h4>
