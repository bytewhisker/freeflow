            ...
            <div className="p-8 space-y-6">
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-4 p-4 bg-blue-50/50 rounded-2xl border border-blue-100">
                  ...
                  <div>
                    <p className="font-black text-slate-900 text-lg uppercase leading-none mb-1">{state.settings.currency.code}</p>
                  ...
                  {filteredCurrencies.map(curr => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div className="text-left text-xs font-bold text-slate-900 uppercase">{curr.code} - {curr.name}</div>
                      </div>
            ...
            <div className="p-8 space-y-8">
              <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-slate-100">
                <div>
                  ...
                  <p className="text-[10px] uppercase font-bold text-slate-400 tracking-wider mt-1">Show logo on invoices</p>
                </div>
                <button
