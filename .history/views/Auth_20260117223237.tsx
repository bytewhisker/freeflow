            ...
            <div className="p-10">
              ...
              <form onSubmit={handleAuth} className="space-y-6">
                <div className="space-y-2">
                  <label className="label-work-email font-black text-[15px] text-gray-500">Email</label>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center px-1">
                    <label className="text-[10px] label-work-email font-black text-[15px] text-gray-500 ">Secret Key</label>
                    {!isSignUp && (
