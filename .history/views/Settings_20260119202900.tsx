...
const Settings: React.FC<{ state: AppState; setState: any }> = ({
  ...
  return (
    <div className="max-w-7xl mx-auto py-12 px-4 md:px-6 lg:px-8 space-y-8">
      {/* Header */}
              ...
              <CardContent>
                ...
                {state.settings.profile?.avatarUrl ? (
                  <img
                    ...
                    alt="Avatar"
                    className="w-20 h-20 rounded-full object-cover border-2 border-white shadow-lg mb-4"
                  />
                ) : (
                  <div className="w-20 h-20 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white text-3xl font-roboto-bold mb-4">
