...
const Projects: React.FC<{ state: AppState, setState: any }> = ({ state, setState }) => {
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB]">
      <div className="max-w-7xl mx-0 px-2 py-4">
        {/* Navigation Bar */}
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex space-x-8">
              <button
                ...
                className={`pb-3 px-1 border-b-2 font-semibold transition-all duration-200 ${
                  activeTab === 'todo'
            ...
            <div className="flex items-center gap-3">
              ...
              <button 
                ...
                className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-200"
              >
                <Plus size={18} />
                Add New
              </button>
        ...
        {/* Add Project Form */}
        {showAdd && (
          <div className="bg-white p-8 rounded-xl border border-gray-200 shadow-xl space-y-6 animate-in zoom-in-95 duration-200 mb-8">
            <div className="flex justify-between items-center">
              <h3 className="text-xl font-bold text-gray-900">{editingProject ? 'Edit Project' : 'New Project'}</h3>
              <button onClick={resetForm} className="p-2 hover:bg-gray-100 rounded-full"><X size={24} /></button>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
               <div className="space-y-1">
                <label className="block text-sm font-bold text-gray-500 uppercase">Project Title</label>
                <input 
                  className="w-full px-4 py-3 bg-white border border-gray-300 text-gray-900 rounded-lg outline-none focus:ring-2 focus:ring-blue-500/20" 
              ...
              <div className="space-y-1">
                <label className="block text-sm font-bold text-gray-500 uppercase">Client</label>
                <select 
                  className="w-full px-4 py-3 bg-white border border-gray-300 text-gray-900 rounded-lg outline-none focus:ring-2 focus:ring-blue-500/20"
              ...
              <div className="space-y-1">
                <label className="block text-sm font-bold text-gray-500 uppercase">Budget Amount ({state.settings.currency.symbol})</label>
                <input 
                  type="number"
                  className="w-full px-4 py-3 bg-white border border-gray-300 text-gray-900 rounded-lg outline-none" 
                  value={formData.totalBudget}
                  onChange={e => setFormData({...formData, totalBudget: parseFloat(e.target.value) || 0})}
                />
              </div>
               <div className="space-y-1">
                <label className="block text-sm font-bold text-gray-500 uppercase">Deadline</label>
                <input 
                  type="datetime-local"
                  className="w-full px-4 py-3 bg-white border border-gray-300 text-gray-900 rounded-lg outline-none" 
              ...
              <div className="space-y-1">
                <label className="block text-sm font-bold text-gray-500 uppercase">Status</label>
                <select 
                  className="w-full px-4 py-3 bg-white border border-gray-300 text-gray-900 rounded-lg outline-none"
              ...
              <div className="space-y-1">
                <label className="block text-sm font-bold text-gray-500 uppercase">Category</label>
                <select 
                  className="w-full px-4 py-3 bg-white border border-gray-300 text-gray-900 rounded-lg outline-none"
            ...
            <div className="space-y-1">
              <label className="block text-sm font-bold text-gray-500 uppercase">Internal Notes</label>
              <textarea 
                className="w-full px-4 py-3 bg-white border border-gray-300 text-gray-900 rounded-lg outline-none h-24"
                value={formData.description}
                onChange={e => setFormData({...formData, description: e.target.value})}
              />
            </div>
            <div className="flex justify-end gap-3">
              <button onClick={resetForm} className="px-6 py-2 text-gray-500 font-bold">Cancel</button>
              <button onClick={handleSubmit} className="bg-blue-600 text-white px-10 py-3 rounded-lg font-bold shadow-lg shadow-blue-100 hover:bg-blue-700 hover:shadow-xl hover:shadow-blue-500/25 transition-all duration-300 text-base">
                        ...
                        return (
                          <span className={`inline-flex items-center gap-1.5 text-xs font-semibold px-3 py-1 rounded-full ${
                            ...
                            <div className={`w-2 h-2 rounded-full ${status.dotColor} ${
                              urgency.urgency === 'overdue' ? 'animate-ping' : ''
                            }`}></div>
                            {status.label}
                          </span>
                        );
                ...
                <div className="px-6 py-4 border-t border-gray-100">
                  ...
                  <div className="mt-3 flex justify-between items-center">
                    ...
                    <button 
                      ...
                      className={`px-4 py-2 text-sm font-semibold rounded-lg transition-all duration-200 hover:shadow-md ${
