    ...
    <div className="space-y-8 animate-in fade-in duration-500 max-w-6xl pb-20">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-2 font-medium">Manage your personal profile, business details, and preferences.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        <div className="space-y-8">
              ...
              <div className="space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="space-y-2">
                    <label className="text-xs font-black text-slate-400 label-work-email   ml-1">Full Name</label>
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-black text-slate-400 label-work-email   ml-1">Professional Title</label>
                    <div className="relative group">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="space-y-2">
                    <label className="text-xs font-black text-slate-400 label-work-email   ml-1">Personal Website</label>
                    <div className="relative group">
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-black text-slate-400 label-work-email   ml-1">Avatar URL</label>
                    <div className="relative group">
                ...
                <div className="space-y-2">
                  <label className="text-xs font-black text-slate-400 label-work-email   ml-1">Short Bio</label>
                  <div className="relative group">
          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div className="p-8 space-y-6">
              ...
              <div className="space-y-5">
                <div className="space-y-2">
                  <label className="text-xs font-black text-slate-400 label-work-email   ml-1">Business Name</label>
                  <div className="relative group">
                ...
                <div className="space-y-2">
                  <label className="text-xs font-black text-slate-400 label-work-email   ml-1">Email Address</label>
                  <div className="relative group">
                ...
                <div className="space-y-2">
                  <label className="text-xs font-black text-slate-400 label-work-email   ml-1">Phone Number</label>
                  <div className="relative group">
                ...
                <div className="space-y-2">
                  <label className="text-xs font-black text-slate-400 label-work-email   ml-1">Physical Address</label>
                  <div className="relative group">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div className="p-8 space-y-6">
              ...
              <div className="space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="space-y-2">
                    <label className="text-xs font-black text-slate-400 label-work-email   ml-1">Bank Name</label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-black text-slate-400 label-work-email   ml-1">Account / IBAN</label>
                    <input
                      type="text"
                      className="w-full px-4 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-600 font-bold transition-all"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="space-y-2">
                    <label className="text-xs font-black text-slate-400 label-work-email   ml-1">Routing / Sort</label>
                    <input
                      type="text"
                      className="w-full px-4 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-600 font-bold transition-all"
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-black text-slate-400 label-work-email   ml-1">SWIFT / BIC</label>
                    <input
                      type="text"
                      className="w-full px-4 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-600 font-bold transition-all"
                ...
                <div className="space-y-2 pt-2">
                  <label className="text-xs font-black text-slate-400 label-work-email   ml-1">PayPal Email / Me Link</label>
                  <input
                    type="text"
                    className="w-full px-4 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-600 font-bold transition-all"
          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div className="p-8 space-y-6">
              <div className="space-y-2">
                <label className="text-xs font-black text-slate-400 label-work-email   ml-1">Active Currency</label>
                <div className="flex items-center gap-4 p-4 bg-blue-50/50 rounded-2xl border border-blue-100">
                  ...
                  <div>
                    <p className="font-black text-slate-900 text-lg label-work-email leading-none mb-1">{state.settings.currency.code}</p>
              ...
              <div className="space-y-2">
                <label className="text-xs font-black text-slate-400 label-work-email   ml-1">Change Currency</label>
                <div className="relative group">
                  ...
                  {filteredCurrencies.map(curr => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <span className="text-lg font-black w-8 text-center text-slate-400">{curr.symbol}</span>
                        <div className="text-left text-xs font-bold text-slate-900 label-work-email">{curr.code} - {curr.name}</div>
                      </div>
            ...
            <div className="p-8 space-y-8">
              <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-slate-100">
                <div>
                  ...
                  <p className="text-[10px] label-work-email font-bold text-slate-400 tracking-wider mt-1">Show logo on invoices</p>
                </div>
                <button
              ...
              <div className={`space-y-4 transition-opacity duration-300 ${state.settings.branding.showWatermark ? 'opacity-100' : 'opacity-50 pointer-events-none'}`}>
                <div className="flex items-center justify-between">
                  <label className="text-xs font-black text-slate-400 label-work-email  ">Opacity Level</label>
