  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 max-w-6xl pb-20">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <h1 className="text-3xl font-roboto-bold text-slate-900 tracking-tight font-poppins">Settings</h1>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden ">
            <div className="p-6 border-b border-slate-100 flex items-center gap-3 bg-slate-50/50">
              ...
              <h2 className=" text-2xl font-roboto-bold">Personal Profile</h2>
            </div>
            <div className="p-8 space-y-6">
              <div className="flex items-center gap-6 mb-8">
                {state.settings.profile?.avatarUrl ? (
                  ...
                  <div className="w-20 h-20 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white text-3xl font-roboto-bold shadow-lg shadow-blue-200">
                    {state.settings.profile?.name?.[0] || 'U'}
                  </div>
                )}
                <div>
                  <h3 className="text-lg font-roboto-bold text-slate-900">{state.settings.profile?.name || 'Your Name'}</h3>
              ...
              <div className="space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-roboto-bold   label-work-email ml-1">Professional Title</label>
                    <div className="relative group">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="space-y-2">
                    <label className="text-xs font-roboto-bold   label-work-email ml-1">Personal Website</label>
                    <div className="relative group">
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-roboto-bold   label-work-email ml-1">Avatar URL</label>
                    <div className="relative group">
                ...
                <div className="space-y-2">
                  <label className="text-xs font-roboto-bold   label-work-email ml-1">Short Bio</label>
                  <div className="relative group">
          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="p-6 border-b border-slate-100 flex items-center gap-3 bg-slate-50/50">
              ...
              <h2 className="font-roboto-bold text-lg text-slate-900">Business Details</h2>
            </div>
            <div className="p-8 space-y-6">
              ...
              <div className="space-y-5">
                <div className="space-y-2">
                  <label className="text-xs font-roboto-bold   label-work-email ml-1">Business Name</label>
                  <div className="relative group">
                ...
                <div className="space-y-2">
                  <label className="text-xs font-roboto-bold   label-work-email ml-1">Email Address</label>
                  <div className="relative group">
                ...
                <div className="space-y-2">
                  <label className="text-xs font-roboto-bold   label-work-email ml-1">Phone Number</label>
                  <div className="relative group">
                ...
                <div className="space-y-2">
                  <label className="text-xs font-roboto-bold   label-work-email ml-1">Physical Address</label>
                  <div className="relative group">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="p-6 border-b border-slate-100 flex items-center gap-3 bg-slate-50/50">
              ...
              <h2 className="font-roboto-bold text-lg text-slate-900">Payment Instructions</h2>
            </div>
            <div className="p-8 space-y-6">
              ...
              <div className="space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="space-y-2">
                    <label className="text-xs font-roboto-bold   label-work-email ml-1">Bank Name</label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-roboto-bold   label-work-email ml-1">Account / IBAN</label>
                    <input
                      type="text"
                      className="w-full px-4 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-600 font-bold transition-all"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="space-y-2">
                    <label className="text-xs font-roboto-bold   label-work-email ml-1">Routing / Sort</label>
                    <input
                      type="text"
                      className="w-full px-4 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-600 font-bold transition-all"
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-roboto-bold   label-work-email ml-1">SWIFT / BIC</label>
                    <input
                      type="text"
                      className="w-full px-4 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-600 font-bold transition-all"
                ...
                <div className="space-y-2 pt-2">
                  <label className="text-xs font-roboto-bold   label-work-email ml-1">PayPal Email / Me Link</label>
                  <input
                    type="text"
                    className="w-full px-4 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-600 font-bold transition-all"
          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="p-6 border-b border-slate-100 flex items-center gap-3 bg-slate-50/50">
              ...
              <h2 className="font-roboto-bold text-lg text-slate-900">Regional & Currency</h2>
            </div>
            <div className="p-8 space-y-6">
              <div className="space-y-2">
                <label className="text-xs font-roboto-bold   label-work-email ml-1">Active Currency</label>
                <div className="flex items-center gap-4 p-4 bg-blue-50/50 rounded-2xl border border-blue-100">
                  <div className="w-12 h-12 bg-blue-600 text-white rounded-xl flex items-center justify-center font-roboto-bold text-xl shadow-lg shadow-blue-200">
                    {state.settings.currency.symbol}
                  </div>
                  <div>
                    <p className="font-roboto-bold text-slate-900 text-lg    leading-none mb-1">{state.settings.currency.code}</p>
              ...
              <div className="space-y-2">
                <label className="text-xs font-roboto-bold   label-work-email ml-1">Change Currency</label>
                <div className="relative group">
                  ...
                  {filteredCurrencies.map(curr => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <span className="text-lg font-roboto-bold w-8 text-center  ">{curr.symbol}</span>
          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="p-6 border-b border-slate-100 flex items-center gap-3 bg-slate-50/50">
              ...
              <h2 className="font-roboto-bold text-lg text-slate-900">Brand Watermark</h2>
            </div>
            <div className="p-8 space-y-8">
              ...
              <div className={`space-y-4 transition-opacity duration-300 ${state.settings.branding.showWatermark ? 'opacity-100' : 'opacity-50 pointer-events-none'}`}>
                <div className="flex items-center justify-between">
                  <label className="text-xs font-roboto-bold   label-work-email">Opacity Level</label>
                  <span className="text-xs font-roboto-bold text-blue-600 bg-blue-50 px-2 py-1 rounded-lg">{Math.round(state.settings.branding.watermarkOpacity * 100)}%</span>
                </div>
                <input
                  type="range"
                  min="0.05"
          ...
          <div className="bg-rose-50 rounded-3xl border border-rose-100 p-8 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-lg font-roboto-bold text-rose-950">Sign Out</h3>
                <p className="text-rose-600/80 text-xs font-bold mt-1">End your current session securely on this device.</p>
              </div>
            </div>
            <button
              onClick={() => supabase?.auth.signOut()}
              className="w-full md:w-auto px-8 py-4 bg-white border border-rose-200 text-rose-600 rounded-2xl font-roboto-bold text-xs label-work-email hover:bg-rose-600 hover:text-white hover:border-transparent transition-all shadow-sm hover:shadow-lg hover:shadow-rose-600/20 active:scale-95 whitespace-nowrap"
            >
              Sign Out Now
            </button>
          </div>
