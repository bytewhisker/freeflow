              ...
              <main className="flex-1 flex flex-col min-w-0">
                <header className="h-20 bg-white/80 backdrop-blur-md border-b border-slate-100 flex items-center justify-between px-10 sticky top-0 z-10 no-print">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <Link to="/billing/new" className="flex items-center gap-2 bg-slate-900 hover:bg-slate-800 text-white px-6 py-3 rounded-2xl text-xs font-black uppercase   transition-all shadow-xl shadow-slate-200">
                      <Plus size={16} />
                      Create Entry
                    </Link>
                  </div>
